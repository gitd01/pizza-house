...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); //to get data attribute
    updateCart(pizza);
    // console.log(pizza);
  });
});
...
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); // ... used for copying an object
